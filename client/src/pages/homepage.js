        ...
        <div className="uk-padding-large">
            <div className="uk-grid">
                ...
                <div className="uk-width-1-2">
                    ...
                    <div className="uk-margin-large-top uk-card uk-card-default uk-card-body"><div className="uk-grid"><div className="uk-width-1-6 uk-background-secondary"></div><div className="uk-width-5-6"> <h3 className="uk-card-title"> Take Quizzes </h3>Students can take a quiz from anywhere on any device.   </div></div></div>
                    <div className="uk-margin-large-top uk-card uk-card-default uk-card-body"><div className="uk-grid"><div className="uk-width-1-6 uk-child-width-expand uk-background-secondary"> <img src={quizimage} uk-img="true" className="quizimage"/></div><div className="uk-width-5-6"> <h3 className="uk-card-title"> Check Your Grades </h3>As soon as the student is done taking a quiz they will be able to instantly see their grade. </div></div></div>
                </div>
